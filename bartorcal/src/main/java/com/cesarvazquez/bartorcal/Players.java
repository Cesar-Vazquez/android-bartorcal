...
import com.cesarvazquez.bartorcal.adapters.AdapterPlayers;
...
public class Players extends BaseListActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        data = dataManager.get(DataManager.players);
        adapter = new AdapterPlayers(this, R.layout.players_hole, data);
